...
public class BireBirChatActivity<CircleImageView, MesajAdaptor> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kullaniciMesajlariListesi.setAdapter((RecyclerView.Adapter) mesajAdaptor);
        ...
        sohbeteGondermeOku.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent sohbet = new Intent(BireBirChatActivity.this,MainActivity.class);
        ...
        dosyaGondermeButtonu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(BireBirChatActivity.this);
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            mesajYolu.updateChildren(mesajGovdesiDetaylari).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    ...
                                    {
                                        yuklemeBar.dismiss();
                                        Toast.makeText(BireBirChatActivity.this, "Mesaj Gönderildi!", Toast.LENGTH_LONG).show();
                                    }
                                    else
                                    {
                                        yuklemeBar.dismiss();
                                        Toast.makeText(BireBirChatActivity.this, "Mesaj gönderme hatalı!!!", Toast.LENGTH_SHORT).show();
                                    }
